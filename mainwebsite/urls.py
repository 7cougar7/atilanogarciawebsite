...
urlpatterns = [
    ...
    path(r'rollsapi/<int:roll_size>/', views_dnd.dnd_rolls_api, name='dnd_rolls_api'),
    ...
    path(r'url_shortener_submit/', views.url_shortener_submit, name='urlShortenerSubmit'),
    ...
    path(r'twilio_incoming/', twilio_views.twilio_incoming, name='twilio_incoming'),
    path(r'twilio_menu_action/', twilio_views.twilio_menu_action, name='twilio_menu_action'),
    ...
    path(r'establish_language_menu/', translator_calls.establish_language_menu, name='establish_language_menu'),
]
